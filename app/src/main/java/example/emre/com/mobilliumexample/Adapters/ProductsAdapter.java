...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.ViewHolder> {
    ...
    public ProductsAdapter(ArrayList<Product> datas) {
        this.products = datas;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.textView2.setText(products.get(position).getShop().getName());
        Picasso.get().load(products.get(position).getImages().get(0).getURL()).centerCrop().fit().into(holder.imageView);
